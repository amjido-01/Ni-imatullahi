  ...
  return (
    <div>
                ...
                <div className='relative'>
                    <img src={deskstopImg} alt="work" className="hidden image lg:block"/>
                   <img src={mobileImage} alt="work" className="block image lg:hidden "/>
                   ...
                   <div className='flex items-center justify-center border2'>
                    ...
                    <div>
                        <img src={liveIcon} className='w-[1.75rem] h-[1.75rem] md:w-[3.78594rem] md:h-[3.78594rem] exclude' alt="live" />
                    </div>
                   </div>
                   </div>
                </div>
