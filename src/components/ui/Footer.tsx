        ...
        <footer className="bg-[#F4F4F4] mt-[4rem]">
            <div className="w-full p-4 mx-auto mt-auto">
                <div className="border-2 border-red-500 text-[#010101] flex items-center justify-center mt-[14.9rem]">
                    ...
                    <div className='flex items-center border-2 border-red-500 w-full gap-[7.38rem]'>
                        <div>
                             <Button variant="outline"className='text-[#010101] text-[1rem] flex gap-[0.75rem] 
                             bg-[#F4F4F4] items-center md:text-[1.5rem] style font-bold leading-[120%] px-[2rem] py-[2rem] rounded-[3.125rem] border-[4px] border-[#000] border-solid'>
                        Contact Me Now
