...
export const Services:React.FunctionComponent = () => {
  return (
    <div className='mt-[10rem] md:pt-[12.25rem] border2 flex justify-center service'>
      ...
      <img className='hidden sm:block' src=     {proud} alt="text" />
         ...
         <ServicesCard title={cardData[0].title} largeIcon={cardData[0].largeIcon} icon={cardData[0].icon} content={cardData[0].content}/>
         </div>
        </div>
